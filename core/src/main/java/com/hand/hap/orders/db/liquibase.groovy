package com.hand.hap.orders.db
//package com.myhap.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "com/myhap/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType,["com/hand/hap","com/myhap"] ,["table", "data", "patch"])
