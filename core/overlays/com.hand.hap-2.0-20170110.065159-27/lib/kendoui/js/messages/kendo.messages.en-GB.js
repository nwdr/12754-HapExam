/**
 * Kendo UI v2016.2.714 (http://www.telerik.com/kendo-ui) Copyright 2016 Telerik
 * AD. All rights reserved.
 * 
 * Kendo UI commercial licenses may be obtained at
 * http://www.telerik.com/purchase/license-agreement/kendo-ui-complete If you do
 * not own a commercial license, this file shall be governed by the trial
 * license terms.
 *
 *
 * 
		...
		(function() {
			(function($, undefined) {
				...
				if (kendo.ui.NumericTextBox) {
					kendo.ui.NumericTextBox.prototype.options = $.extend(true,
				...
				if (kendo.ui.Pager) {
					kendo.ui.Pager.prototype.options.messages = $.extend(true,
				...
				if (kendo.spreadsheet && kendo.spreadsheet.messages.toolbar) {
					kendo.spreadsheet.messages.toolbar = $.extend(true,
				...
				if (kendo.ui.Slider) {
					kendo.ui.Slider.prototype.options = $.extend(true,
				...
				if (kendo.ui.TreeList) {
					kendo.ui.TreeList.prototype.options.messages = $.extend(
							true, kendo.ui.TreeList.prototype.options.messages,
							{
				...
				if (kendo.ui.TreeList) {
					kendo.ui.TreeList.prototype.options.columnMenu = $.extend(
							true,
				...
				if (kendo.ui.TreeView) {
					kendo.ui.TreeView.prototype.options.messages = $.extend(
							true, kendo.ui.TreeView.prototype.options.messages,
							{
								"loading" : "Loading...",
								"requestFailed" : "Request failed.",
								"retry" : "Retry"
					...
					kendo.ui.Upload.prototype.options.localization = $
							.extend(
									...
									kendo.ui.Upload.prototype.options.localization,
									{
										...
										"invalidMaxFileSize" : "size can not more than {0}",
										"invalidMinFileSize" : "size can not less than {0}",
										"invalidFileExtension" : "file is not invalid. Supported file types are {0}."
									});
				}
