...
<#list columnsInfo as infos>
    <#if infos.tableColumnsName?ends_with("Code")||infos.tableColumnsName?ends_with("Name")||infos.tableColumnsName?ends_with("Type")>
        <input type="text"  data-role="maskedtextbox" style="float:left;width:150px;margin-right:5px;" placeholder='${'<@spring.message '}"${dtoName}.${infos.tableColumnsName}"/>' data-bind="value:model.${infos.tableColumnsName}" class="k-textbox">
    </#if>
</#list>
<#--</#list>
    <#list 1..4 as i>
